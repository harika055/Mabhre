                ...
                <div className="flex flex-col gap-6 Xxl:pb-20 pb-10">
                    <div className="flex items-start gap-2 md:gap-6">
                        ...
                        <p className="text-white/70 max-w-md">
                            Building the future with <span className="text-primary">sustainable energy</span>,{" "}
                            <span className="text-primary">smart technologies</span>, and{" "}
                            <span className="text-primary">innovative infrastructure</span>.
                        </p>
                    </div>
                    <div className="flex flex-col lg:flex-row items-start lg:items-end gap-4">
                        <h1 className="large-heading">MABHRE</h1>
                        <div>
                            <NavigationLink navigationTitle="Learn More" navigationLink="/about-us" transform={false} />
                        </div>
                    </div>
                </div>
            </div>
