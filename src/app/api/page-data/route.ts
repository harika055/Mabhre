...
const servicesData = {
    ...
    name: "Services",
    heading: "What we do",
    description: "A glimpse into our innovation—delivering sustainable energy, advanced technology, and transformative digital solutions that shape the future.",
    data: [
        {
            id: 1,
